...
* [Speech to Text / Vertex AI Qwiklabs [14:33]](https://www.youtube.com/watch?v=-p-AwIk8CsQ)
...
On the other end you have customizable ML frameworks (e.g., TensorFlow, VertexAI) that allow you to build your own ML algorithms and train them with your own data.  This type of approach gives you full control over the entire process while still leveraging the cloud infrastructure.  
...
## Bespoke ML Models with VertexAI/AI Platform (i.e., fully flexible yet more difficult)
...
Interestingly, AI Platform is in the process of being deprecated.  It is still available to use, however it is being moved into [VertexAI](https://cloud.google.com/vertex-ai).

Next, we'll go through a demo on both a VertexAI and an AI Platform codelab.  Definitely check it out if you can!
...
For some more fun, here are a pair of demos using the Qwiklabs of looking at a very similar demo (Speech to Text) as well as VertexAI for some image generation

> * Module video [Speech to Text / Vertex AI Qwiklabs [14:33]](https://www.youtube.com/watch?v=-p-AwIk8CsQ) and associated Qwiklabs [Speech-to-Text API: Qwik Start](https://www.cloudskillsboost.google/focuses/588?parent=catalog), [Build an AI Image Generator app using Imagen on Vertex AI ](https://www.cloudskillsboost.google/focuses/96792?catalog_rank=%7B%22rank%22%3A4%2C%22num_filters%22%3A0%2C%22has_search%22%3Atrue%7D&parent=catalog&search_id=39778861).
...
I needed to include this as it is bleeding-edge new, but want to preface that I have never played with this technology myself.  If you want to try your hand at Generative AI / LLMs, here you go: [Generative AI Overview](https://ai.google/discover/generativeai).
